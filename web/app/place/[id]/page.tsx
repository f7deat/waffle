...
import { apiPlaceDetail, apiPlaceRandom, apiPlaceList } from '@/service/locations/place';
                ...
                <div className="max-w-4xl">
                    ...
                    {relatedPlaces.length > 0 && (
                        <div className="mt-12 pt-8 border-t">
                            <h2 className="text-2xl font-bold mb-6">More on {place.streetName}</h2>
                            {loadingRelated ? (
                                    ...
                                    {relatedPlaces.map((relatedPlace) => (
                                        <Link key={relatedPlace.id} href={`/place/${relatedPlace.id}`}>
                                            <div className="group cursor-pointer h-full">
                                                <div className="relative overflow-hidden rounded-lg mb-3 bg-gray-200">
                                                    <img
