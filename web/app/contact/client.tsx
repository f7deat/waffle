                ...
                <div className="rounded-xl bg-white p-6 dark:border-slate-800 dark:bg-slate-900">
                    ...
                    <div className="space-y-5">
                        <div>
                            ...
                            <a href={`mailto:${settings?.email}`} className="text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300">
                                {settings?.email}
                            </a>
                        </div>
                        ...
                        <div>
                            ...
                            <a href={`tel:${settings?.phoneNumber}`} className="text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300">
