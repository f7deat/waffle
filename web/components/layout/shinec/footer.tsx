          ...
          <div className="flex gap-4">
            ...
            <div className="flex-1 font-bold flex items-center flex-col gap-4">
              <div className="text-2xl text-white">
                <span className="text-green-700"><PhoneOutlined /></span> {settings?.phoneNumber}
              </div>
      ...
      <div className="mx-auto container py-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400">Địa chỉ: {settings?.address}</p>
            <p className="text-gray-400">Email: {settings?.email}</p>
            <p className="text-gray-400">Điện thoại: {settings?.phoneNumber}</p>
          </div>
          <div>
