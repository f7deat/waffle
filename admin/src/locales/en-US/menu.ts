export default {
  ...
  'menu.hr': 'HR',
  'menu.hr.statistics': 'Statistics',
  'menu.hr.branch': 'Branches',
  'menu.hr.department': 'Departments',
  'menu.hr.team': 'Teams',
  'menu.hr.teamMembers': 'Team Members',
  ...
  'menu.tool.websiteBuilder': 'Website builder',
  'menu.login': 'Login',
