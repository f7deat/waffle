...
const sectionItems = [
  { id: "gioi-thieu", label: "Giới thiệu", icon: faLeaf },
  { id: "loi-the", label: "Lợi thế", icon: faChartLine },
  { id: "ha-tang", label: "Hạ tầng", icon: faIndustry },
  { id: "tin-tuc", label: "Tin tức", icon: faNewspaper },
  { id: "hinh-anh", label: "Hình ảnh", icon: faImage },
  { id: "lien-he", label: "Liên hệ", icon: faPhone },
];
...
export function SiteHeader({ currentPage }: SiteHeaderProps) {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-white/20 bg-[var(--primary)]/95 backdrop-blur-md">
          ...
          <div className="hidden items-center gap-2 md:flex">
            ...
            >
              <span className="inline-flex items-center gap-1.5">
                <FontAwesomeIcon icon={faNewspaper} className="h-3 w-3" />
                Trang Tin tức
              </span>
            </Link>
            <Link
      ...
      >
        ...
        <nav className="mt-6 grid gap-2">
          {sectionItems.map((item, index) => (
            ...
            >
              <FontAwesomeIcon icon={item.icon} className="h-4 w-4 text-[var(--primary)]" />
              {item.label}
            </a>
          ))}
        </nav>
        ...
        <div className="mt-6 grid gap-2">
          ...
          >
            Trang Tin tức
            <FontAwesomeIcon icon={faArrowUpRightFromSquare} className="h-3.5 w-3.5 text-[var(--accent-deep)]" />
          </Link>
          <Link
            href="/lien-he"
