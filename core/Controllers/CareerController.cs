...
public class CareerController(IJobOpportunityService _jobOpportunityService, IWebHostEnvironment _webHostEnvironment, UserManager<ApplicationUser> _userManager) : BaseController
{
    [HttpPost("save")]
