...
public class PartialViewName
{
    ...
    public const string NoData = "/Pages/Components/Empty/NoData.cshtml";
    public const string Premium = "/Pages/Components/Empty/Premium.cshtml";
    public const string Link = "~/Pages/Shared/Components/Link/Default.cshtml";
}
