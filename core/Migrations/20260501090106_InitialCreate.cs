        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Avatar = table.Column<string>(type: "nvarchar(2058)", maxLength: 2058, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Collections", x => new { x.CatalogId, x.CollectionId });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    JobRequirements = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    SalaryRange = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    JobLocation = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AffiliateLink = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: true),
                    Content = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AffiliateLinks_Catalogs_CatalogId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rooms_Catalogs_CatalogId",
                        column: x => x.CatalogId,
                        principalTable: "Catalogs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Rooms_Catalogs_CityId",
                        column: x => x.CityId,
                        principalTable: "Catalogs",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UploadBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FileContents_Folders_FolderId",
                        column: x => x.FolderId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobApplications_JobOpportunities_JobId",
                        column: x => x.JobId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TagCatalogs", x => new { x.CatalogId, x.TagId });
                    table.ForeignKey(
                        name: "FK_TagCatalogs_Catalogs_CatalogId",
                        column: x => x.CatalogId,
                        principalTable: "Catalogs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TagCatalogs_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AffiliateLinks_CatalogId",
            ...
            migrationBuilder.CreateIndex(
                name: "idx_Localizations_Language_Key",
                table: "Localizations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TagCatalogs_TagId",
                table: "TagCatalogs",
                column: "TagId");

            migrationBuilder.CreateIndex(
                name: "IDX_WorkContent_Id",
                table: "WorkContents",
                column: "Id");

            migrationBuilder.CreateIndex(
                name: "IDX_WorkItem_CatalogId",
                table: "WorkItems",
                column: "CatalogId");

            migrationBuilder.CreateIndex(
                name: "IDX_WorkItem_WorkId",
                table: "WorkItems",
                column: "WorkId");
        }
